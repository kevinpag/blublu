...
local Highlight = (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://raw.githubusercontent.com/kevinpag/blublu/refs/heads/main/SimpleSpyNew/Highlight.lua"))()
local LazyFix = loadstring(game:HttpGet("https://raw.githubusercontent.com/kevinpag/blublu/refs/heads/main/SimpleSpyNew/Dependencies/Libraries/Serializer.luau"))() 
...
if not getgenv().SimpleSpyExecuted then
    local succeeded,err = pcall(function()
        ...
        logthread(spawn(function()
            local suc,err = pcall(game.HttpGet,game,"https://raw.githubusercontent.com/kevinpag/blublu/refs/heads/main/SimpleSpyNew/UpdateLog.lua")
...
if configs.supersecretdevtoggle then
    ...
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/kevinpag/blublu/refs/heads/main/SimpleSpyOld/SimpleSpy.lua"))()
    end)
    newButton("Load SSV3",function()
        return "Load's Simple Spy V3"
    end,
    function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/kevinpag/blublu/refs/heads/main/SimpleSpyNew/SimpleSpySource.lua"))()
    end)
